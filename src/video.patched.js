...
_V_.ControlBar = _V_.Component.extend({
  ...
  init: function(player, options){
    ...
    player.addEvent("play", this.proxy(function(){
      ...
      // add by Kevin, dirty tricks
      // In fact, addEvent is a cross-browser wrapper 
      // of attachEvent and addEventListener(Mozilla)
      //
      var cvs3d = document.getElementById('display');
      cvs3d.addEventListener("mouseover", this.proxy(this.fadeIn),false);
      cvs3d.addEventListener("mouseout", this.proxy(this.fadeOut),false);
    }));
  },
...
================================================================================ */
  ...
  requestFullScreen: function(){
    ...
    if (requestFullScreen) {
     ...
     processor.enterFullScreen(document.getElementById("videoDiv").offsetLeft - document.body.scrollLeft, document.getElementById("videoDiv").offsetTop - document.body.scrollTop);
